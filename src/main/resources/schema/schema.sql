...
CREATE TABLE IF NOT EXISTS `db_events`.`tbl_subscription` (
  `subscription_number` BINARY(16) NOT NULL,
  `subscribed_user_id` BINARY(16) NOT NULL,
  `indication_user_id` BINARY(16) NULL DEFAULT NULL,
  `event_id` BINARY(16) NOT NULL,
  ...
  CONSTRAINT `fk_tbl_subscription_tbl_event1`
    ...
    REFERENCES `db_events`.`tbl_event` (`event_id`),tbl_eventtbl_event
